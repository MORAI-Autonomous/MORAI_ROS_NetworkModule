...
class sync_planner():
    def __init__(self):
        ...
        #def
        self.global_path=path_reader.read_txt(self.path_name+".txt") ## 경로의 이름
        ...
        frame_step = int(sync_mode_on.time_step / TIMES_STEP)
        ...
        # ctrl_cmd.command.longlCmdType = 2
        ...
        while not rospy.is_shutdown():
            try:
                ...
                if control_input > 0 :
                    ...
                    ctrl_cmd.command.brake = 0.0
                else :
                    ctrl_cmd.command.accel = 0.0
